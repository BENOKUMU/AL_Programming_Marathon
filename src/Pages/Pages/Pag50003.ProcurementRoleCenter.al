page 50003 "Procurement Role Center"
{
    ...
    layout
    {
        area(RoleCenter)
        {
            ...
            {
                ShowCaption = false;
                part(Control1997001; "Purchase Agent Activities")
                {
                    ApplicationArea = All;
                }
                part(Control1997002; "My Vendors")
                {
                    ApplicationArea = All;
                }
...
{
    ProfileDescription = 'Procurement Officer';
    RoleCenter = "Procurement Role Center";
