page 50005 "Procurement Plan Header"
{
    DeleteAllowed = false;
    ApplicationArea = All;
        ...
        area(Processing)
        {
            ...
            group("Request Approval")
            {
                ...
                action(CancelApprovalRequest)
                {
                    ...
                    begin
                        ...
                        // IF CONFIRM('Are you sure you want to cancel the Procurement Plan %1. Do you want to continue?', FALSE, Rec."No.") THEN
            ...
            group(Approval)
            {
                ...
                action(Approve)
                {
                    ...
                    begin
                        IF CONFIRM('Are you sure you want to approve the Procurement Plan %1. Do you want to continue?', FALSE, Rec."No.") THEN
                ...
                action(Reject)
                {
                    ...
                    var
                        ApprovalsMgmt: Codeunit "Approvals Mgmt.";
                    begin
                        IF CONFIRM('Are you sure you want to reject the Procurement Plan %1. Do you want to continue?', FALSE, Rec."No.") THEN
