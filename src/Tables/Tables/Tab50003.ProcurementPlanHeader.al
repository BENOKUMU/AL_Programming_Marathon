table 50003 "Procurement Plan Header"
{
    ...
    fields
    {
        ...
        field(2; "Employee Code"; Code[20])
        {
            ...
            begin
                ...
                //     end;
                // end;
                // if NAVemp.Get("Employee Code") then
        ...
        {
            CalcFormula = Count("Approval Entry" WHERE("Table ID" = CONST(51931),
        ...
        {
            CalcFormula = Exist("Procurement Plan Lines" WHERE("No." = CONST(''),
                                                           "Plan No" = FIELD("No.")));
            FieldClass = FlowField;
        }
    ...
    // UsersRec: Record "QuantumJumps User Setup";
    ...
    begin
        if "AGPO Reservation" <> 0 then begin
            "% of AGPO Reservation" := "AGPO Reservation" / "Total Estimate" * 100;
        end;
    end;
